  ...
  return (
    <div className="home-tutorial">
      ...
      <div id="tutorial-colorpop">
        <p className="function-text">컬러팝</p>
      ...
      <div id="tutorial-replace">
        <p className="function-text">객체 변경</p>
        <p className="tutorial-text">
      ...
      <div id="tutorial-emoji">
        <p className="function-text">이모지 추가</p>
        <p className="tutorial-text">
      ...
      <div id="tutorial-blur">
        <p className="function-text">블러</p>
        <p className="tutorial-text">
      ...
      <div id="tutorial-?">
        <p className="function-text">이미지 객체 인식</p>
        <p className="tutorial-text">
